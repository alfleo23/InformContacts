// Licence file \\Mac\Home\Documents\ReversePOCO.txt not found.
...
namespace InformContacts
{
    ...
    {
        DbSet<Contact> Contacts { get; set; } // Contacts
    ...
    public class MyDbContext : DbContext, IMyDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=MockDatabase;Integrated Security=True");
            }
        }
    ...
    public class ContactConfiguration : IEntityTypeConfiguration<Contact>
    {
        public void Configure(EntityTypeBuilder<Contact> builder)
        {
            ...
            builder.HasKey(x => x.ContactId).HasName("PK__Contacts__5C66259B8926BF45").IsClustered();

            builder.Property(x => x.ContactId).HasColumnName(@"ContactId").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.FirstName).HasColumnName(@"First Name").HasColumnType("nchar(30)").IsRequired(false).IsFixedLength().HasMaxLength(30);
            builder.Property(x => x.LastName).HasColumnName(@"Last Name").HasColumnType("nchar(30)").IsRequired(false).IsFixedLength().HasMaxLength(30);
            builder.Property(x => x.Company).HasColumnName(@"Company").HasColumnType("nchar(50)").IsRequired(false).IsFixedLength().HasMaxLength(50);
            builder.Property(x => x.PhoneNumber).HasColumnName(@"Phone Number").HasColumnType("varchar(20)").IsRequired(false).IsFixedLength().HasMaxLength(20);
        }
    }
